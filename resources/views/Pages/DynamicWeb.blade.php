...
<div id="wrapper"><!--Goes with CSS layout.-->
    <div id="content"><!--Goes with CSS layout.-->
        ...
        <h3 id="mainhead">Big Header</h3>
        <p>This is where all the content will be located </p>
        <p>This is where all the content will be located </p>
        <p>This is where all the content will be located </p>
        <p>This is where all the content will be located </p>
        <h4>Subheader</h4>
...
<div id="footer"><p>&copy; Copyright by Reason Charles Hlongwane 2020 &amp;DMCInsights,Inc.</p></div>
